...
pipwerks.SCORM.API.get = function(){
    ...
    if(win.parent && win.parent != win){ 
     ...
     //this is a popup, look for API in parent window
        if(!API && win.top.opener){
        //look for popup's parent window
            var popup_parent = win.top.opener;
            API = find(popup_parent);
            //Still no API?
            //if the popup's parent ALSO has a parent,
            //it's a second popup. Look for it's
            //parent, too
            if(!API && popup_parent.top.opener){
                    API = find(popup_parent.top.opener);
            }
        } 
